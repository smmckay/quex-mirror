QUEX_INLINE void
QUEX_NAME(utf32_utf8_character)(const QUEX_TYPE_LEXATOM**  input_pp, 
                                uint8_t**                  output_pp)
{
...
QUEX_INLINE void
QUEX_NAME(utf32_utf16_character)(const QUEX_TYPE_LEXATOM**  input_pp, 
                                 uint16_t**                 output_pp)
{
    uint32_t   tmp = 0;
...
QUEX_INLINE void
QUEX_NAME(utf32_utf32_character)(const QUEX_TYPE_LEXATOM**  input_pp, 
                                 uint32_t**                 output_pp)
{
