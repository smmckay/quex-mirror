...
QUEX_NAMESPACE_MAIN_OPEN
static void
test_file(E_ConverterTestType CTT, const char* Codec, bool LinearF, bool ClueLessStomachF, 
          const char* FileName, const char* FileStem)
{
    ...
    std::ifstream                 istr(FileName, std::fstream::in);
