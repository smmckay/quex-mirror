/* vim:set ft=c: -*- C++ -*- */
#ifndef QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__BUFFER__BUFFER_MEMORY_I
#define QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__BUFFER__BUFFER_MEMORY_I
...
#endif /*  QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__BUFFER__BUFFER_MEMORY_I */
