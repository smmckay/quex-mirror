/* vim:set ft=c: -*- C++ -*- */
#ifndef __QUEX_INCLUDE_GUARD__BUFFER__BUFFER_INVARIANCE_I
#define __QUEX_INCLUDE_GUARD__BUFFER__BUFFER_INVARIANCE_I
...
#endif /* __QUEX_INCLUDE_GUARD__BUFFER__BUFFER_INVARIANCE_I */
