...
#ifndef  QUEX_INCLUDE_GUARD__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
#define  QUEX_INCLUDE_GUARD__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
...
QUEX_NAMESPACE_MAIN_OPEN
    ...
    QuexConverter_ICU_new()
    {
        QuexConverter_ICU*  me = \
             (QUEX_NAME(Converter_ICU)*)QUEX_GNAME_LIB(MemoryManager_allocate)(sizeof(QUEX_NAME(Converter_ICU)),
