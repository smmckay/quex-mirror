...
#ifndef  QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__BUFFER__LEXATOMS__LEXATOM_LOADER_PLAIN_I
#define  QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__BUFFER__LEXATOMS__LEXATOM_LOADER_PLAIN_I
/**/
