...
#ifndef  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_FILE_I
#define  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_FILE_I
...
QUEX_NAME(ByteLoader_FILE_new)(FILE* fh, bool BinaryModeF)
{
    ...
    me = (QUEX_NAME(ByteLoader_FILE)*)QUEX_GNAME_LIB(MemoryManager_allocate)(sizeof(QUEX_NAME(ByteLoader_FILE)),
...
#endif /*  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_FILE_I */
