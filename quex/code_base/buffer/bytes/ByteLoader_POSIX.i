...
#ifndef  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_POSIX_I
#define  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_POSIX_I
...
QUEX_NAME(ByteLoader_POSIX_new)(int fd)
{
    ...
    me = (QUEX_NAME(ByteLoader_POSIX)*)QUEX_GNAME_LIB(MemoryManager_allocate)(sizeof(QUEX_NAME(ByteLoader_POSIX)),
...
#endif /*  QUEX_INCLUDE_GUARD__BUFFER__BYTES__BYTE_LOADER_POSIX_I */
