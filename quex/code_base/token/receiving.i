...
#ifndef QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__ANALYZER__MEMBER__TOKEN_RECEIVING_I
#define QUEX_INCLUDE_GUARD_$$LEXER_CLASS$$__ANALYZER__MEMBER__TOKEN_RECEIVING_I
