...
typedef struct QUEX_SETTING_USER_CLASS_DECLARATION_EPILOG quex_TestAnalyzer_tag {
    ...
    QUEX_NAME(Mode)* (__memory_mode_stack[sizeof(QUEX_NAME(Mode)*)*QUEX_SETTING_MODE_STACK_SIZE]);
