...
#ifdef    QUEX_SETTING_LEXATOM_LOADER_SEEK_BUFFER_SIZE_EXT
#  define QUEX_SETTING_LEXATOM_LOADER_SEEK_BUFFER_SIZE    QUEX_SETTING_LEXATOM_LOADER_SEEK_BUFFER_SIZE_EXT
#else
#  define QUEX_SETTING_LEXATOM_LOADER_SEEK_BUFFER_SIZE    512
#endif
