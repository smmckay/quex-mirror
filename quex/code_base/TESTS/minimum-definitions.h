...
#define QUEX_SETTING_BUFFER_LEXATOM_BUFFER_BORDER                 0
#define QUEX_SETTING_BUFFER_LEXATOM_NEWLINE 0x0A
...
#  define QUEX_SETTING_BUFFER_LEXATOM_LOADER_SEEK_BUFFER_SIZE    QUEX_SETTING_BUFFER_LEXATOM_LOADER_SEEK_BUFFER_SIZE_EXT
#else
#  define QUEX_SETTING_BUFFER_LEXATOM_LOADER_SEEK_BUFFER_SIZE    512
#endif
...
#  define QUEX_SETTING_BUFFER_FALLBACK_N   QUEX_SETTING_BUFFER_FALLBACK_N_EXT
#else
#  define QUEX_SETTING_BUFFER_FALLBACK_N  4
#endif
...
#define QUEX_SETTING_BUFFER_LEXATOM_LOADER_CONVERTER_BUFFER_SIZE 512
