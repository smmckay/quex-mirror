...
def test(state):
    ...
    output_trigger_map(state.target_map.get_trigger_map(), BeforeF=True)
    state.target_map.replace_drop_out_target_states_with_adjacent_targets()
    output_trigger_map(state.target_map.get_trigger_map(), BeforeF=False)
