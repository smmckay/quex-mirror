...
test(size_t Size0, size_t ContentSize0, size_t Size1, size_t ContentSize1)
{
    ...
    if( Size0 ) {
        buffer_0[0]       = QUEX_EasyLexer_SETTING_BUFFER_LEXATOM_BUFFER_BORDER;
        buffer_0[Size0-1] = QUEX_EasyLexer_SETTING_BUFFER_LEXATOM_BUFFER_BORDER;
        end_of_content_p  = &buffer_0[ContentSize0+1];
        *end_of_content_p = QUEX_EasyLexer_SETTING_BUFFER_LEXATOM_BUFFER_BORDER;
    ...
    if( Size1 ) {
        buffer_1[0]       = QUEX_EasyLexer_SETTING_BUFFER_LEXATOM_BUFFER_BORDER;
        buffer_1[Size1-1] = QUEX_EasyLexer_SETTING_BUFFER_LEXATOM_BUFFER_BORDER;
