...
#if defined(QUEX_CONVERTER_CHAR)
...
#define    QUEX_CONVERTER_CHAR(FROM, TO)      __QUEX_CONVERTER_CHAR_DEF(FROM, TO)
#define    QUEX_CONVERTER_STRING(FROM, TO)    __QUEX_CONVERTER_STRING_DEF(FROM, TO)
...
#   define QUEX_CONVERTER_CHAR      QUEX_CONVERTER_CHAR_DEF_BACKUP
#   define QUEX_CONVERTER_STRING    QUEX_CONVERTER_STRING_DEF_BACKUP
